var quiz = {
    ...
    data: [
      {//1.Data is Array of objects 2.Object Array of options
...
init: () => {
                ...
                // (B1) WRAPPER
                //It maps the quiz.hWrap from css 
...
setTimeout(() => {
  if (quiz.now < quiz.data.length) {
    ...
    quiz.hQn.innerHTML = `You have answere${quiz.score} of ${quiz.data.length} correctly.`;
    quiz.hAns.innerHTML = "";
}
}, 1000);
},
